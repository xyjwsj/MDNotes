...
import {
    ...
    CloseOutlined,
    CloudUploadOutlined,
    DeleteOutlined, DribbbleOutlined,
    ExportOutlined,
    LayoutOutlined,
    MoreOutlined,
    PlusOutlined,
    ...
    setup(_) {
        ...
        const LanguageView = styled.div`
            ...
            .langItem {
                ...
                background-color: ${() => settingInfoStore.DarkTheme() ? 'rgba(255, 255, 255, 0.2)' : ''};
        ...
        const hotKey = () => {
            ...
            modalView.width = "60%"
            modalView.icon = (
                <Image preview={false} width={25} src={settingInfoStore.DarkTheme() ? keyboardLight : keyboardDark}/>
            );
            modalView.content = (
                <HotKeyView>
                    {hotKeyInfo.map(item => {
                        return <>
                            ...
                            {item.data.map(itm => {
                                return <span class={'item'}>{`${itm.key} ${itm.desc}`}</span>
                            })}
                        </>
                    })}
                </HotKeyView>
        ...
        const changeLang = () => {
            ...
            modalView.width = "30%"
            modalView.icon = (
                <Image preview={false} width={25} src={settingInfoStore.DarkTheme() ? langLight : langDark}/>
            );
            modalView.content = (
                <LanguageView>
                    {languageInfo.map(item => {
                        return <span class={'langItem'} onDblclick={() => {
